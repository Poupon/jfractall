/*
phipo/PhiLib/Interface/PPIntField.java
...
//*****************************
public class PPIntField extends PPField{

	//----------------
public	PPIntField( String p_str, int p_val, int p_sens ){
	super( p_str, Integer.toString( p_val ), p_sens );

	}	
	//----------------
public	int  getInt(){
			return Integer.parseInt(  c_text.getText() );	 
	}
	//----------------
public	void setInt(int p_val){
		c_text.setText( Integer.toString( p_val ) );		
	}
}
//*****************************
