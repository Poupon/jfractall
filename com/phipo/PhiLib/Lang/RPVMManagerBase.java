...
//**********************************************************
public class RPVMManagerBase implements RPVMManager{
	boolean c_traceflag = false;

	public RPVMManagerBase(){
	}
	//-----------------
	public void processError( RPVMException p_ex ){
		System.out.println( "processError:" + p_ex );
	}
	//------------------
	public void processError( String p_str ){
		System.out.println( "processError:" +p_str );
	}
	//------------------
	public void processTrace( String p_str ){
		System.out.println( "processTrace:" +p_str );
	}
	//-----------------	
	public boolean getTraceFlag() { return c_traceflag; }
	public boolean setTraceFlag(boolean p_flag) { return c_traceflag = p_flag; }
	//-----------------	
}
//**********************************************************
